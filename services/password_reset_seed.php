...
// Send password reset email
    ...
    $passwordmessage .= "<p style='background-color: " . $_SESSION['emailtheme'] . "; font-size: 30px; font-weight: bold; color: white; padding: 25px; width=100%;'> " . $_SESSION['orgname'] . "</p>";
    ...
    $domain_url = "https://" . $_SESSION['domainname'] . "/pass_renew.php?a=recover@email=";
    // $passwordLink = "https://tec.ourfamilyconnections.org/pass_renew.php?a=recover&email=" . $key . "&u=" . urlencode(base64_encode($username3));
    ...
    header('Location: //tec.ourfamilyconnections.org/welcome.php');
}
