<?php
// ***************************************************************
// Process profile update - CHILDREN (name, gender, birthdate, etc.) INFO: Called from profile_children_delete.js
...
switch ($child_number)
    ...
    case '1': // Child 1
	    ...
	    $childdirremove = $mysql->query($childdirremovequery) or die("A database error occurred when trying to update child 1 info. See profile_children_delete.php. Error:" . $mysql->errno . " : " . $mysql->error);
	    ...
	    $childrenremove = $mysql->query($childrenremovequery) or die("A database error occurred when trying to update child 1 info. See profile_children_delete.php. Error:" . $mysql->errno . " : " . $mysql->error);
    ...
    case '2':  // Child 2
	    ...
	    $childdirremove = $mysql->query($childdirremovequery) or die("A database error occurred when trying to update child 2 info. See profile_children_delete.php. Error:" . $mysql->errno . " : " . $mysql->error);
	    ...
	    $childrenremove = $mysql->query($childrenremovequery) or die("A database error occurred when trying to update child 2 info. See profile_children_delete.php. Error:" . $mysql->errno . " : " . $mysql->error);
    ...
    case '3':  // Child 3
	    ...
	    $childdirremove = $mysql->query($childdirremovequery) or die("A database error occurred when trying to update child 3 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
	    ...
	    $childrenremove = $mysql->query($childrenremovequery) or die("A database error occurred when trying to update child 3 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
    ...
    case '4':  // Child 4
	    ...
	    $childdirremove = $mysql->query($childdirremovequery) or die("A database error occurred when trying to update child 4 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
	    ...
	    $childrenremove = $mysql->query($childrenremovequery) or die("A database error occurred when trying to update child 4 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
    ...
    case '5':  // Child 5
	    ...
	    $childdirremove = $mysql->query($childdirremovequery) or die("A database error occurred when trying to update child 5 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
	    ...
	    $childrenremove = $mysql->query($childrenremovequery) or die("A database error occurred when trying to update child 5 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
    ...
    case '6':  // Child 6
	    ...
	    $childdirremove = $mysql->query($childdirremovequery) or die("A database error occurred when trying to update child 6 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
	    ...
	    $childrenremove = $mysql->query($childrenremovequery) or die("A database error occurred when trying to update child 6 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
    ...
    case '7':  // Child 7
	    ...
	    $childdirremove = $mysql->query($childdirremovequery) or die("A database error occurred when trying to update child 7 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
	    ...
	    $childrenremove = $mysql->query($childrenremovequery) or die("A database error occurred when trying to update child 7 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
    ...
    case '8':  // Child 8
	    ...
	    $childdirremove = $mysql->query($childdirremovequery) or die("A database error occurred when trying to update child 8 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
	    ...
	    $childrenremove = $mysql->query($childrenremovequery) or die("A database error occurred when trying to update child 8 info. See profile_children_update.php. Error:" . $mysql->errno . " : " . $mysql->error);
