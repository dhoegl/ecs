    ...
    adminjQ("#email_submit").on("click", function () {
        ...
        var email_send = adminjQ.ajax({
            ...
            data: {
                ...
                "theme_domain": domain,
                "theme_name": customer,
                "theme_color": headercolorvalue,
                "theme_forecolor": headerforecolorvalue,
                "Family": family_select_entry,
                "Admin": admin_dir_entry,
                "login_id": param1_entry,
                "first_name": param2_entry,
                "last_name": param3_entry,
                "email_address": param4_entry,
