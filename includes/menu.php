<?php
    ...
    if($activeparam == '5')
    {
        echo '<li class="nav-item active" id="prayer_service"><a class="nav-link" href="prayer.php">Prayer</a></li>';
    }
    else
    {
        echo '<li class="nav-item" id="prayer_service"><a class="nav-link" href="prayer.php">Prayer</a></li>';
    }
    if($activeparam == '6')
    {
        echo '<li class="nav-item active" id="events_service"><a class="nav-link" href="#">Events</a></li>';
    ...
    echo"<script language='javascript'  src='/js/config_ajax_call.js'></script>";
?>
