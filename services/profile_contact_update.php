...
/* Process profile update -CONTACT INFO: Called from profile.php */
if(isset($_POST['submitcontact']))
	...
	$contactupdate = $mysql->query($contactupdatequery) or die("A database error occurred when trying to update contact info. See profile_contact_update.php. Error : " . $mysql->errno . " : " . $mysql->error);
	...
	$loginemailupdate_him = $mysql->query($loginemailupdatequery_him) or die("A database error occurred when trying to update login email info. See profile_contact_update.php. Error : " . $mysql->errno . " : " . $mysql->error);
	...
	$loginemailupdate_her = $mysql->query($loginemailupdatequery_her) or die("A database error occurred when trying to update login email info. See profile_contact_update.php. Error : " . $mysql->errno . " : " . $mysql->error);
