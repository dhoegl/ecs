...
$result = $mysql->query($sqlquery) or die("A database error occurred when trying to select registrants for Dir and Login Table. See regadmin.php. Error : " . $mysql->errno . " : " . $mysql->error);
...
// Get User Login details
    include('includes/get_loggedinuser.php');
...
jQ10(document).ready(function () {
    ...
    jQ10("#ModalApproveRegistrant").modal('show');
		...
		$approveURL = "newregistrantaccept.php?registerid=" + $approveclickbuttonid;
            ...
            jQ10("#modal_approve_submit").click(function () {
                if (!testforSelect) { // no existing member selected - force user to select 'new family'
                    ...
                    .done(function (jqXHR, textStatus) {
                        ...
                        console.log("ajax response data for regadmin = " + teststat);
                        console.log("ajax response text for regadmin = " + teststat2);
...
jQ11(document).ready(function () {
    ...
    jQ11("#unregisteredapplicant tbody").on("click", '.applicant_reject', function () {
        ...
        $rejectURL = "newregistrantreject.php?registerid=" + $rejectclickbuttonid;
...
<script type="text/javascript">
	...
	jQ30(document).ready(function() {
        ...
        if (testforChild.hasClass("child")) {
    		...
    		var sendaddress = 'get_registrant_email_address.php';
