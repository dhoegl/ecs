...
if(isset($_POST['registersubmit']))
{
    ...
    echo "<script language='javascript'>";
    echo "console.log('register_submit.php - idDirectory = " . $regInsert_DirID . "');";
    echo "</script>";
    ...
    echo "</script>";
    // eventLogUpdate('report error', 'register_submit.php', 'Error: ' . $mysql->error , 'Error #: ' . $mysql->errno);
...
<body>
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="navbar-header">
            <a class="navbar-brand" href="../welcome.php">TEC Family Connections</a>
        </div>
    </nav>
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="text-center">
                                    ...
                                    <h4 class="white-text text-center">
                                        <i class="white-text"></i>Click <a href="//tec.ourfamilyconnections.org/welcome.php">HERE</a> to return to the Sign In page.
                                    </h4>
                                </div><!--text-center-->
                            </div>
                        </div>
